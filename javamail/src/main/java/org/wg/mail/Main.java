...
public class Main {
	...
	public static String myEmailAccount = "bianyi_run@163.com";
	public static String myEmailPassword = "gang0000";
	...
	// 收件人邮箱（替换为自己知道的有效邮箱）
	public static String receiveMailAccount = "1289868863@qq.com";
